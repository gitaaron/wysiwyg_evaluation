...
!function($, wysi) {
    ...
    var methods = {
        ...
        bypassDefaults: function(options) {
            return this.each(function () {
                var $this = $(this);
                g_wysiEditor = new Wysihtml5($this, options);
                $this.data('wysihtml5', g_wysiEditor);
            });
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["./bootstrap-wysihtml5/lib/css/wysiwyg-color.css", "./bootstrap-wysihtml5/lib/css/wysiwyg-font.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
